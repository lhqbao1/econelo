...
export const metadata: Metadata = {
  ...
  description:
    "Das Impressum von Econelo – Rechtliche Angaben, Kontaktdaten und gesetzliche Informationen gemäß deutscher Gesetzgebung.",
  alternates: {
    canonical: "https://econelo.de/impressum",
  },
  openGraph: {
    title: "Impressum | Econelo",
    description:
