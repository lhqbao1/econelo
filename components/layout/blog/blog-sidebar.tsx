            ...
            <div className="flex gap-4" key={product.id}>
              ...
              <div className="flex-1">
                <Link
                  ...
                  className=""
                >
                  <p className="hover:text-primary transition line-clamp-2 font-semibold">
                    {product.name}
                  </p>
                </Link>
                {firstBlog && (
                  <Link
                    ...
                    className="mt-2 block text-sm text-gray-600 hover:text-primary transition line-clamp-2"
                  >
                    {firstBlog.title}
                  </Link>
                )}
