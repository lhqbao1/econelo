...
export const cartSupplierColumn: ColumnDef<CartItem>[] = [
  {
    ...
    header: "ID",
    cell: ({ row }) => {
      return <div>#{row.original.products.id_provider}</div>;
    },
  },
  {
    accessorKey: "sku",
    ...
    cell: ({ row }) => {
      return <div className="text-center">{row.original.products.sku}</div>;
    },
  },
  {
    accessorKey: "ean",
...
export const getDeliveryOrderColumns = ({
...
}: DeliveryOrderColumnProps = {}): ColumnDef<CartItem>[] => [
  {
    accessorKey: "id",
    header: "ID",
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-center">{row.original.products.name}</div>;
    },
  },
  {
    accessorKey: "sku",
